...
Records for undernames can be set using the [setRecord](/build/ar-io-sdk/ants/set-record) method on the [AR.IO SDK](/build/ar-io-sdk), or removed by using the [removeRecord](/build/ar-io-sdk/ants/remove-record) method.
