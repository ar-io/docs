...
export const metadata = {
  ...
  description: 'Deploy a dApp with ArDrive web',
  openGraph: {
    title: 'Deploy a dApp with ArDrive web',
  },
}
...
Learn more about preparing your dApp for deployment [here](https://docs.ardrive.io/docs/misc/deploy/).
...
The Data TX ID you copied in Step 6 is long and difficult to remember. To make it easier to access your dApp or website, you can assign a friendly name to it using [ArNS](/learn/arns). If you already own an ArNS name, you will be prompted during the creation of 
your manifest if you want to assign one. If you do not, you can purchase one from [arns.app](https://arns.arweave.net).
...
Files uploaded to Arweave are permanent and immutable. They cannot be changed. However, the [Arweave File System (ArFS)](https://docs.ardrive.io/docs/arfs/) protocol used (and created) by ArDrive lets you "replace" them with new versions while still being able to access the old ones. You can do this with entire dApps as well. The old files won't be displayed in the ArDrive web app unless you click on a file to view its history.
