...
`updateGatewaySettings` is a method on the `IO` class that writes new gateway settings to the caller's gateway configuration.
  ...
  <table className="inline-table">
    ...
    <tbody>
      <tr>
        <th>qty</th>
        <td>number</td>
        <td>Number of tokens, in `mIO` to stake when joining network.</td>
        <td>false</td>
      </tr>
      <tr>
        <th>autoStake</th>
      ...
      <tr>
        ...
        <td>number</td>
        <td>Minimum number of tokens, in `mIO` that can be delegated to the gateway.</td>
        <td>false</td>
      </tr>
      <tr>
