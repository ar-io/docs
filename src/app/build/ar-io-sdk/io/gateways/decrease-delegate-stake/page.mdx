...
`decreaseDelegateStake` is a method on the `IO` class that increases the caller's stake on the target gateway.
  ...
  <table className="inline-table">
    ...
    <tbody>
      <tr>
        <th>qty</th>
        <td>number</td>
        <td>Number of tokens, in `mIO` to remove from delegate stake.</td>
        <td>false</td>
      </tr>
      <tr>
        <th>target</th>
