...
`setBaseNameRecord` is a method on the `ANT` class that adds or updates the base name record for the ANT. This is the top level name of the ANT (e.g. ardrive.ar.io).
