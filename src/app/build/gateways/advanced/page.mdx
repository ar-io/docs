...
View examples of the admin endpoints [here](/build/gateways/admin)
...
Gateways, by default, forward requests to resolve ArNS names to [arweave.dev](https://arweave.dev). Starting with [Release 9](/build/gateways/release-notes#release-9---2024-04-10) gateways can instead build and maintain their own local cache. Doing so removes external dependencies and allows faster resolution.
