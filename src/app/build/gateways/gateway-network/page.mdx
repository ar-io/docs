...
The AR.IO Network consists of AR.IO [gateway nodes](/build/gateways), which are identified by their registered Arweave wallet addresses and either their IP addresses or hostnames, as stored in the network's [smart contract](/learn/ario-contract) Gateway Address Registry (GAR).  
