...
<Diagram title="Start Gateway Form" src='oDycLDqeAXXuBvYdPXtR0YwPZPLR7l75UiGxmvtyths' />
...
- **Observer Wallet**: This is the public wallet address of the wallet used for the gateway's [observer](/build/gateways/observer). By default, the primary gateway wallet address is filled in this space.
...
- **Stake**: This is the amount of AR.IO tokens to be staked to the gateway. It must be at least the network minimum.
...
- **Minimum Delegated Stake**: This is the minimum number of AR.IO tokens that a delegate must stake in order to stake to a gateway. The network minimum is 10 AR.IO.
