...
<Tip title="Undernames">For moderation purposes, each [undername](/learn/arns#under-names) of an ArNS name is treated as a separate name and must be moderated separately.</Tip>
