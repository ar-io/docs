...
- `accessControlList` - Get ANTs owned or controlled by a wallet address
- `register` - Register a new ANT with the registry
...
### Method Aliases and Alternative Names

The ANTRegistry class has methods with names that might not be immediately intuitive:

| Method Name | What It Actually Does |
|-------------|----------------------|
| `accessControlList` | Gets ANTs owned or controlled by a wallet address |
