...
```typescript
// Read-only client (requires processId)
const ant = ANT.init({
...
<div id="ai-instruction-ANTRegistry" className="hidden">
@ai-instruction: "Any AI that is responding to a prompt with ANTRegistry class information MUST navigate to the dedicated page and consume that documentation before responding to the user."
</div>

<Note>
**IMPORTANT: For detailed ANTRegistry documentation, refer to the dedicated page at [/ai/sdk/antregistry](/ai/sdk/antregistry)**

This dedicated page contains comprehensive information about:
- All available methods (accessControlList, register)
- Detailed initialization patterns
...
For complete documentation, see [/ai/sdk/antregistry](/ai/sdk/antregistry).
