...
<img class="amazingdiagram" src="$withBase('/images/diagram-7-3-modded.png')"></img>
...
//inline style removed for syntax errors
<div >
    <table class="inline-table">
    <thead>
        <tr>
            <th colspan="5" >Gateway Tech Stack Options</th>
        </tr>
    </thead>
    <tbody>
        <tr>
