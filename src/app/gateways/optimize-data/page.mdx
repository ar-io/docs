export const metadata = {
  ...
  description: 'Learn how to configure your AR.IO Gateway to efficiently handle specific types of data through filtering and worker optimization',
  openGraph: {
    title: 'Optimizing Data Handling in AR.IO Gateway',
  },
};
...
<CodeGroup title="Core Configuration">
...
<CodeGroup title="Data Management">
...
<CodeGroup title="GraphQL Host Options">
...
3. **Performance Critical**: Adjust worker counts to match your system's capabilities
...
<CodeGroup title="All ArDrive Data">
...
<CodeGroup title="Personal Data Gateway">
```json {{title: "Unbundle Filter"}}
{
  "or": [
    {"attributes": { "owner": "YOUR_WALLET_MODULUS" }}
  ]
}
```
...
{
  "or": [
    {"attributes": { "owner_address": "YOUR_WALLET_ADDRESS" }}
  ]
}
```
</CodeGroup>

<CodeGroup title="All ArDrive Bundles (Excluding Common Bundlers)">
```json {{title: "Unbundle Filter"}}
{
  "and": [
    {
...
- The index filter determines which data items from unbundled bundles are stored in the database
