...
2. Assign your dApp's transaction Id to an ArNS name
3. Set the environment variable:
   ```bash
   APEX_ARNS_NAME=your-ArNS-name
   ```
4. Restart your gateway
5. Your dApp will now be served from your gateway's apex domain
...
- [arweave.tech](https://arweave.tech) - Serves a custom landing page with information about their gateway service
