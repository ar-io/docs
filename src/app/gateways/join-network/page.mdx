...
The simplest method for joining a new gateway to the [Gateway Address Registry (GAR)](/gateways/gateway-network#gateway-address-registry-gar) is to use the [Network Portal](https://gateways.arweave.net/#/gateways).
