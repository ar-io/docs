export const metadata = {
  ...
  description:
    'Detailed information about each version of the AR.IO SDK, including the enhancements, bug fixes, and any other changes introduced in every release.',
  openGraph: {
    title: 'AR.IO SDK Release Notes',
  },
}
...
## [3.17.2](https://github.com/ar-io/ar-io-sdk/compare/v3.17.1...v3.17.2) (2025-08-09)
...
- **arns:** append paidBy to query params on fundfrom turbo arns purcahaes PE-7943 ([11333e8](https://github.com/ar-io/ar-io-sdk/commit/11333e8f9c0540b1f98af68ada417e1e052d282a1c93fb07))

## [3.11.0](https://github.com/ar-io/ar-io-sdk/compare/v3.10.0...v3.11.0) (2025-05-15)
...
## [3.10.0](https://github.com/ar-io/ar-io-sdk/compare/v3.9.1...v3.10.0) (2025-04-15)

### Bug Fixes

- **types:** update types for better compatibility ([9c0540b](https://github.com/ar-io/ar-io-sdk/commit/9c0540b1f98af68ada417e1e052d282a1c93fb07))
...
- **messaging:** only retry messaging if no id was received ([9cbffef](https://github.com/ar-io/ar-io-sdk/commit/9cbffef365a8307ca8e97baff1b4ac7d4bb811de))
...
[View changes on Github](<(https://github.com/ar-io/ar-io-sdk/compare/v3.7.1...v3.8.0)>)
...
[View changes on Github](<(https://github.com/ar-io/ar-io-sdk/compare/v3.7.0...v3.7.1)>)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.6.1...v3.7.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.6.2-alpha.1...v3.7.0-alpha.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.6.1...v3.6.2-alpha.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.6.0...v3.6.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.5.3...v3.6.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.5.2...v3.5.3)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.5.1...v3.5.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.5.0...v3.5.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.4.1...v3.5.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.4.0...v3.4.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.3.1...v3.4.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.3.0...v3.3.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.2.0...v3.3.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v3.1.0...v3.2.0)
...
- **ARIO token:** update all IO references to ARIO ([8fb2188](https://github.com/ar-io/ar-io-sdk/commit/8fb2188fecd673ed6ad1c66fc710f2fdc6cc70eb))
...
- **ARIO token:** All exported IO and IOToken are now repleced with ARIO and ARIOToken respectively

PE-7225

# [2.6.0] (2024-12-05)

[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.5...v2.6.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.4...v2.5.5)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.3...v2.5.4)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.2...v2.5.3)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.1...v2.5.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.5.0...v2.5.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.4.0...v2.5.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.3.2...v2.4.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.3.1...v2.3.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.3.0...v2.3.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.5...v2.3.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.4...v2.2.5)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.3...v2.2.4)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.2...v2.2.3)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.1...v2.2.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.2.0...v2.2.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.1.0...v2.2.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.0.2...v2.1.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.0.1...v2.0.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v2.0.0...v2.0.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.2.2...v2.0.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.2.0...v1.2.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.1.1...v1.2.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.1.0...v1.1.1)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.8...v1.1.0)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.7...v1.0.8)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.6...v1.0.7)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.5...v1.0.6)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.4...v1.0.5)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.3...v1.0.4)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.2...v1.0.3)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.1...v1.0.2)
...
[View changes on GitHub](https://github.com/ar-io/ar-io-sdk/compare/v1.0.0...v1.0.1)
