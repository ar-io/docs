...
<Table>
  ...
  <Table.Body>
    <Table.Row>
      <Table.Cell className="font-semibold">controller</Table.Cell>
      <Table.Cell>string - WalletAddress</Table.Cell>
      <Table.Cell>The public wallet address of the controller to be removed</Table.Cell>
...
<CodeGroup title="removeController">
