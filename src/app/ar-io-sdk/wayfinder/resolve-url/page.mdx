  ...
  <table className="inline-table">
    ...
    <tbody>
      <tr>
        <th>path</th>
        <td>string</td>
        <td>The path or transaction ID to resolve to a full URL</td>
        <td>false</td>
      </tr>
    </tbody>
  </table>
...
<CodeGroup title="resolveUrl">
    ...
    async function main() {
      ...
      // Resolve ArNS names
      const arnsUrl = await wayfinder.resolveUrl('/ardrive');
    ...
    async function main() {
      ...
      const paths = [
        '/YTB0dGJURWpqQ25iS2NaY1RPSi1TOUQxMmd3cGRFaHUzV2hiWnVlZ2o5WT0',
        '/graphql',
        '/ar-io/info',
        'ar://ardrive'
      ];
