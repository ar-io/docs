...
<div style={{ textAlign: 'center' }}>
  <table className="inline-table">
    ...
    <tbody>
      <tr>
        <th>verification-succeeded</th>
        <td>Object with txId: string</td>
        <td>Fired when data verification passes</td>
      </tr>
      <tr>
        <th>verification-failed</th>
        <td>Error</td>
        <td>Fired when data verification fails</td>
      </tr>
      <tr>
        <th>verification-skipped</th>
        <td>Object with originalUrl: string</td>
        <td>Fired when verification is skipped (no transaction ID found)</td>
      </tr>
      <tr>
        <th>verification-progress</th>
        <td>Object with txId, processedBytes, totalBytes</td>
        <td>Fired during streaming verification progress</td>
      </tr>
      <tr>
        <th>routing-started</th>
        <td>Object with originalUrl: string</td>
        <td>Fired when routing process begins</td>
      </tr>
      <tr>
        <th>routing-skipped</th>
        <td>Object with originalUrl: string</td>
        <td>Fired when routing is skipped (non-string URL)</td>
      </tr>
      <tr>
        <th>routing-succeeded</th>
        <td>Object with originalUrl, selectedGateway, redirectUrl</td>
        <td>Fired when routing succeeds</td>
      </tr>
      <tr>
        <th>routing-failed</th>
        <td>Error</td>
        <td>Fired when routing fails</td>
      </tr>
      <tr>
        <th>identified-transaction-id</th>
        <td>Object with originalUrl, selectedGateway, txId</td>
        <td>Fired when a transaction ID is identified for verification</td>
      </tr>
    </tbody>
  </table>
</div>
