...
2. Retrieve a list of active AR.IO Gateways from the [GAR](/build/gateways/gateway-network#gateway-address-registry-gar) by reading the contract state, or other available resources, and then fetch content from a gateway on the list.
...
<center><img src="https://arweave.net/59RvZcZuIV4uGs-GcLlhlnsD9cDqaG9HqEJCIJzcsMs"></img></center>
