...
ArNS is a censorship-resistant naming system stored on Arweave, powered by [ARIO tokens](/learn/token), enabled through [AR.IO gateway](/build/gateways) domains, and used to connect friendly domain names to permaweb apps, web pages, data, and identities.  
...
With ArNS, the registry is stored permanently on Arweave via [AO](/learn/glossary#ao-computer-ao), making it immutable and globally resilient. 
