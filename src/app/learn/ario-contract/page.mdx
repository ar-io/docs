...
Written in Lua and compiled to WASM64, it is deployed as a Process within [AO](/learn/glossary#ao-computer-ao), leveraging the decentralized infrastructure of Arweave for immutability and auditability. 
...
The Protocol Balance is the primary sink and source of [ARIO tokens](/learn/token) circulating through the AR.IO Network. 
...
This balance is stored like any other token balance in the AR.IO smart contract, using the contract’s [Process ID](/learn/glossary#process-id-pid) as the balance owner. 
