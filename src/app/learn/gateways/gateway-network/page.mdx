...
<div style={{textAlign: "center"}}>
    ...
    <thead>
        ...
        <tr>
            <th>delegates</th>
            <td>object</td>
            <td className="align-left">Wallets that have delegated a stake of IO tokens to the Gateway.</td>
        </tr>
        <tr>
            <th>totalDelegatedStake</th>
            <td>number</td>
            <td className="align-left">The total number of IO tokens delegated to the Gateway</td>
        </tr>
        <tr>
...
<div style={{textAlign: "center"}}>
    ...
    <thead>
        ...
        <tr>
            <th>balance</th>
            <td>number</td>
            <td className="align-left">Positive integer, the number of IO tokens locked.</td>
        </tr>
        <tr>
            <th>start</th>
            <td>number</td>
...
<div style={{textAlign: "center"}}>
    ...
    <thead>
        ...
        <tr>
            ...
            <td>boolean</td>
            <td>no</td>
            <td className="align-left">The Gateway Operator can allow or disallow other wallets to stake IO tokens on the Gateway.</td>
        </tr>
        <tr>
