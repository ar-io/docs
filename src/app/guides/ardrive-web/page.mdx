...
The Data TX ID you copied in Step 6 is long and difficult to remember. To make it easier to access your dApp or website, you can assign a friendly name to it using [ArNS](/arns). If you already own an ArNS name, you will be prompted during the creation of 
