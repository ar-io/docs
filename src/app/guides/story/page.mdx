...
<PackageManagerTabs 
  npm="npm install --save @ardrive/turbo-sdk @story-protocol/core-sdk viem dotenv ts-node typescript"
  pnpm="pnpm install @ardrive/turbo-sdk @story-protocol/core-sdk viem dotenv ts-node typescript"
  yarn="yarn add @ardrive/turbo-sdk @story-protocol/core-sdk viem dotenv ts-node typescript"
/>
