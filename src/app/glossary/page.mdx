import PermawebGlossary from '@/components/PermawebGlossary'
import { GlossaryUrl } from '@/components/GlossaryUrl'

export const metadata = {
  title: 'Glossary',
  description:
    'Comprehensive glossary of AR.IO, Arweave, and permaweb terminology and concepts',
  openGraph: {
    title: 'Glossary',
  },
}
...
Process: A decentralized computation unit in the AO framework, enabling scalable, parallel execution via message-passing. Each process maintains its own state, interacts asynchronously, and is permanently stored on Arweave for transparency and immutability​.
...
For a more comprehensive glossary of terms used in the permaweb, try the <GlossaryUrl>Permaweb Glossary</GlossaryUrl>. Or use it below:
