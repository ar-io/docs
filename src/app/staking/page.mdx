...
In the AR.IO ecosystem, "staking" refers to the process of locking a specified amount of [ARIO tokens](/token) into a protocol-controlled vault. 
...
A [gateway](/gateways) operator must stake tokens to join their gateway to the network, which not only makes them eligible for protocol rewards but also promotes network reliability. 
...
However, an exception to these restrictions allows delegated stakers to use their staked tokens for specific [ArNS](/arns)-related services. 
