...
SDK developers will need to update their SDKs to the latest version ([3.8.0](/build/ar-io-sdk/release-notes)). This is a non-breaking change, so existing code will continue to work. However, the process Id for the ARIO mainnet contract has changed. This means that
