...
export const metadata = {
  title: 'AR.IO Network Composition',
  description:
    'Overview of the AR.IO Network composition and the permanent cloud infrastructure including storage, compute, and services layers',
  openGraph: {
    title: 'AR.IO Network Composition',
  },
}
...
<Diagram
  src="https://arweave.net/ztJ2iYMIelFOwc4vXv8iYzPAES4bFCf-sdO5ZIc5bKI"
  title="Diagram 1"
  description="The Permanent Cloud Network"
/>
