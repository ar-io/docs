...
In any editor, open the relevant Nginx configuration file. If the [setup guide configuration](/build/run-a-gateway/quick-start) was used, that file will be located at `/etc/nginx/sites-available/default`.
