...
<Cards>
  ...
  <Card
    ...
    description={
      <>
        <span className="block mb-3">No-code solution for personal and business files</span>
        <div className="space-y-1 text-sm">
          <div className="flex items-center gap-2">
  ...
  <Card
    ...
    description={
      <>
        <span className="block mb-3">Raw protocol access for advanced use cases</span>
