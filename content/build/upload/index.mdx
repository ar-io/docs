...
<Cards>
  <Card
    ...
    description="An ar.io gateway run by the ArDrive team: it serves data like any gateway, and adds paid uploads • Pay with credit cards, AR, ETH, SOL, MATIC • Free uploads under 105 KiB • Automatic retry & confirmation"
