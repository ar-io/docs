...
query {
  transactions(
    tags: [
      { name: "App-Name", values: ["MyApp-v1.0"] }
...
Your App-Name tags enable gateway operators to filter and optimize their infrastructure for your specific data:
...
This allows gateways to process only your application's data, improving performance and reducing resource usage.

<Callout type="info">
  **Gateway Optimization:** Learn how to [optimize your
  gateway](/build/run-a-gateway/optimize-your-gateway-for-your-data) to process
  specific App-Name data efficiently.
</Callout>
