...
Upload data using Turbo, an ar.io gateway run by the ArDrive team. Turbo handles the infrastructure so you can focus on shipping.

## What is Turbo?

Turbo is an ar.io gateway run by the ArDrive team. It serves permanent data like any ar.io gateway, and it adds paid uploads: it bundles your files into ANS-104 data items, issues the credits you pay with, and posts the data permanently to Arweave.

**How the pieces fit.** [ar.io](/learn) is the network: gateways serve and index permanent data, ArNS names it, and anyone can run a gateway. Turbo is one of those gateways, at `turbo-gateway.com`, run by the ArDrive team with uploads and payments attached. [ArDrive](https://app.ardrive.io) is the app built on it. Arweave is the storage layer underneath, where the data ends up.
