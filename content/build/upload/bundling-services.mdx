...
description: "Complete guide to using Turbo's bundling services for reliable Arweave uploads"
---

Upload data to Arweave using **Turbo's bundling services** - the recommended approach for developers and applications. Turbo provides enterprise-grade infrastructure with flexible payment options and optimized performance.
...
- **Multiple Payment Options**: Credit cards, ARIO, USDC, SOL, MATIC, AR
- **Enterprise Reliability**: Built-in redundancy and retry mechanisms
- **Optimized Performance**: Fast uploads with intelligent bundling
- **Developer Friendly**: Simple SDK with comprehensive documentation
...
→ [Understanding Turbo Credits](/how-to-upload-data/turbo-credits)

### Data Organization

- [**Tagging**](/how-to-upload-data/tagging) - Organize your data with metadata
- [**Manifests**](/how-to-upload-data/manifests) - Create folder structures and bundles
- [**Encryption**](/how-to-upload-data/encryption) - Secure your sensitive data
- [**ArFS**](/how-to-upload-data/arfs) - File system protocol for structured storage
...
<Card href="/sdks/turbo-sdk" title="Turbo SDK Documentation" icon={<Code />}>
  ...
  <Card 
    href="/how-to-upload-data/tagging" 
