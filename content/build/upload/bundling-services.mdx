...
Upload data using Turbo, ar.io's managed gateway stack. Turbo handles the infrastructure so you can focus on shipping.

## What is Turbo?

Turbo is ar.io's managed gateway stack, run by the team behind ar.io and ArDrive. It serves permanent data like any ar.io gateway, and it adds what a gateway on its own does not have: paid uploads. It bundles your files into ANS-104 data items, issues the credits you pay with, and posts the data permanently to Arweave.

**How the pieces fit.** [ar.io](/learn) is the network: gateways serve and index permanent data, ArNS names it, and anyone can run a gateway. Turbo is a managed instance of that stack, at `turbo-gateway.com`, with uploads and payments attached. [ArDrive](https://app.ardrive.io) is the app built on it. Arweave is the storage layer underneath, where the data ends up.

So the part that makes Turbo different from a gateway you run yourself is not reading, which it does the same way: it is that Turbo accepts paid uploads, and carries the funding, performance tuning and operational complexity that come with them.
...
If you’re looking for a managed upload service tailored to your use case — including custom limits, performance, or integration support — book a call to learn how we can get one set up for you: [Contact Us!](https://ar.io/contact)
...
- Go to [console.ar.io/topup](https://console.ar.io/topup)
...
<Cards>
  <Card 
    href="https://console.ar.io" 
    title="Launch ar.io Console"
    icon={<Zap />}
  >
