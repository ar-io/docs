...
Upload data using Turbo, the upload and payment service behind ar.io and ArDrive. Turbo handles the infrastructure so you can focus on shipping.

## What is Turbo?

Turbo is the upload and payment service behind ar.io and ArDrive: it bundles your files into ANS-104 data items, issues the credits you pay with, and posts the data permanently to Arweave.

**How the pieces fit.** [ar.io](/learn) is the network that serves and names permanent data, through gateways and ArNS. [ArDrive](https://app.ardrive.io) is the app for storing and sharing files on it. Turbo is the service both use to get data uploaded and paid for. Arweave is the storage layer underneath, where the data ends up.

That makes Turbo the write side. An [ar.io gateway](/learn/gateways) is the read side — it retrieves, caches and serves data, and resolves ArNS names. Turbo abstracts away funding, performance tuning and operational complexity, giving teams a fast, dependable path to permanent storage.
