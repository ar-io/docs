...
Turbo Credits aren't just for uploads — they're also the payment medium for buying, extending and upgrading [ArNS](/learn/arns) names. This draws on the same credit balance as uploads, so no separate top-up is needed if you already hold credits.
