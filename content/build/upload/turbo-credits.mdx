...
**ARIO top ups pay no fee at all.** ARIO converts to credits at its market value, so money spent in ARIO buys roughly 1.5x the storage of the same amount paid any other way.
