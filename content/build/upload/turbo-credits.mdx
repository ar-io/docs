...
- **The top-up fee is inclusive — it comes out of what you pay rather than being added on top.** A $100 top up buys $100 of credits minus the fee, so at 35% you receive credits worth $65. Spending credits carries no percentage fee; the fee applies only on the way in.
...
- A small flat fee is applied per data item at upload time (currently **$0.00002**, i.e. **$0.02 per 1,000 items**) to cover per-item processing overhead. This is separate from and in addition to the byte-based storage cost.
