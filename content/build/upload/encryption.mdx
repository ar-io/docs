...
The [Arweave File System (ArFS)](/build/upload/arfs) protocol provides optional standardization for encrypted storage:
...
<Card href="/build/upload/arfs" title="Learn About ArFS" icon={<FolderOpen />}>
