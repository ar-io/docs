...
<Cards>
  <Card href="/build/run-a-bundler/what-is-a-bundler" title="What is a Bundler?">
...
<Card
  href="/build/run-a-bundler/running-bundler-locally"
...
<Card
  href="/build/run-a-bundler/bundler-configuration"
...
>
  **Configure your bundler** for production use **Key topics:** - Wallet
  ...
  <Card href="/build/run-a-bundler/bundler-as-gateway-extension" title="Bundler as Gateway Extension">
...
**Want to get hands-on?** Jump to [Running a Bundler Locally](/build/run-a-bundler/running-bundler-locally) for immediate setup.

**Need more context?** Explore [What is a Bundler](/build/run-a-bundler/what-is-a-bundler) first.

## Complete Guide

**For comprehensive bundler setup and configuration**, see the [Complete Bundler Guide](/build/extensions/bundler) which covers:
