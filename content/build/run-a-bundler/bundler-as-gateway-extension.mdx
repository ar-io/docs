...
The gateway acts as a proxy for upload operations, forwarding requests to the bundler service while providing a unified interface for users.
...
For detailed API documentation, see the [Turbo Upload Service API](/apis/turbo/upload-service/upload).
...
**For comprehensive setup and advanced configuration**, see the [Complete Bundler Guide](/build/extensions/bundler) which provides detailed instructions for production deployment and troubleshooting.
