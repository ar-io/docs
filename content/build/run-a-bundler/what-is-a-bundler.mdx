...
**Want to get started?** See [Running a Bundler Locally](/build/run-a-bundler/running-bundler-locally).

**Need configuration?** Check [Bundler Configuration](/build/run-a-bundler/bundler-configuration).

**Want integration?** Explore [Bundler as Gateway Extension](/build/run-a-bundler/bundler-as-gateway-extension).

## Complete Guide

**For detailed setup and advanced configuration**, see the [Complete Bundler Guide](/build/extensions/bundler) which provides comprehensive instructions for production deployment.
