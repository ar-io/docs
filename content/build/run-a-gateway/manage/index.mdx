...
<Card title="CDB64 Root TX Index" href="/build/run-a-gateway/manage/cdb64" icon={<Search className="w-6 h-6" />}>
  Configure the CDB64 index for O(1) data item lookups. Three indexes are enabled by default, covering close to 3.8 billion records, for instant historical data resolution.
</Card>
