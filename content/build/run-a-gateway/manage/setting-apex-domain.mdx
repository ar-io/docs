...
1. Visit [ArNS App](https://arns.ar.io)
...
curl -I https://turbo-gateway.com/your-transaction-id

# Test ArNS name resolution
curl -I https://your-arns-name.ar.io
```
...
nslookup your-arns-name.ar.io

# Check if it points to the correct transaction
curl -s https://your-arns-name.ar.io | head -10
```
...
1. Go to [ArNS App](https://arns.ar.io)
