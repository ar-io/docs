...
| `RATE_LIMITER_ALLOWLIST_IPS`              | string  | -         | Comma-separated IP allowlist        |
| `RATE_LIMITER_ALLOWLIST_ARNS_NAMES`       | string  | -         | Comma-separated ArNS allowlist      |
...
| `X_402_CDP_CLIENT_KEY`                 | string  | -              | Coinbase Developer Platform client key     |
| `CDP_API_KEY_ID`                       | string  | -              | CDP API key ID                             |
| `CDP_API_KEY_SECRET_FILE`              | string  | -              | Path to CDP API secret key file            |
