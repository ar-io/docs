...
<Callout type="info">
  Looking to resolve data items faster without a full database? [Index
  Sharing](/build/run-a-gateway/manage/index-sharing) lets your gateway
  subscribe to another gateway's root transaction indexes, a few tens of
  gigabytes kept current, instead of importing a snapshot.
</Callout>
