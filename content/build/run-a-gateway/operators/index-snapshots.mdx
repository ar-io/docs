...
You can also use the [Grafana Extension](/build/run-a-gateway/operators/monitoring-with-grafana) to view the last block imported in a more human readable format.
