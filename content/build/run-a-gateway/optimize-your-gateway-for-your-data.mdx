...
**Advanced Filtering** - For advanced filter syntax, complex use cases, and performance optimization, see our detailed [Optimized Indexing Guide](/build/advanced/advanced-gateway-operation/optimized-indexing).

**Performance Monitoring** - Learn how to monitor your gateway's performance and optimize resource usage with [Grafana Monitoring](/build/advanced/advanced-gateway-operation/monitoring-with-grafana).

**Gateway Management** - Explore comprehensive gateway operation guides in our [Advanced Gateway Operation](/build/advanced/advanced-gateway-operation) section.
