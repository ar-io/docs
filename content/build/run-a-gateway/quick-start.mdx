...
<Callout type="info" title="Learn About AR.IO Gateways">
  New to AR.IO gateways? Learn more about what they are and how they work at [AR.IO Gateways](/learn/gateways).
</Callout>
...
<Cards>
  ...
  <Card 
    ...
    description="Register your own permanent, human-readable name on the AR.IO Network for your applications or content"
    href="/guides/arns/register-arns-name"
