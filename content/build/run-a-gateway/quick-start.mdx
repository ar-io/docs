    ...
    <Steps>
      ...
      <Step>
        ...
        **Add configuration:**
        ...
        <Callout type="info">
        `AR_IO_WALLET` and `OBSERVER_WALLET` must be Solana public keys (base58 Ed25519). The observer address must be unique — no other gateway can use the same observer. The observer wallet needs a small amount of SOL for submitting observation transactions.
        </Callout>
