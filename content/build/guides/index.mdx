...
<Cards>
  ...
  <Card href="/build/guides/find-my-tx" title="Find a File by TXID">
    **Recover bytes from an Arweave ID** even when it’s a bundled data item

    **Key topics:**
    - L1 transactions vs ANS-104 data items
    - Finding bundle parent + offset
    - Wayfinder + chunk-based retrieval
    - When to ask bundlers/gateways
