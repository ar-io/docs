...
description: "Distribute applications permanently using Arweave manifests and ArNS for decentralized, censorship-resistant software delivery"
---
...
Need to **distribute software permanently** without relying on centralized package registries or CDNs? Combine **Arweave manifests** with **ArNS** to create a decentralized distribution system with permanent URLs that never break.

This pattern works for CLI tools, desktop applications, firmware updates, or any downloadable software. You get:

- **Permanent Storage**: Files stored immutably on Arweave, available forever
- **Friendly URLs**: Human-readable ArNS names like `releases.yourapp.arweave.net`
- **Version Management**: Manifest paths create a REST-like API for releases
- **CI/CD Integration**: Automate deployments with GitHub Actions and Turbo SDK
- **No Central Dependencies**: Zero reliance on npm, GitHub Releases, or traditional CDNs

The following case study walks through a real implementation for the Harlequin CLI toolkit.
