...
| --- | --- |
| A few dozen files | Manual upload via [Turbo SDK](/sdks/turbo-sdk) or [console.ar.io](https://console.ar.io/upload) |
...
2. Use the [pricing calculator](https://console.ar.io/pricing) or `turbo.getFiatEstimateForBytes()` from the SDK.
