...
description: "Integrate Turbo SDK directly into vanilla HTML pages using CDN imports"
---
...
<Steps>
  <Step title="Create Basic HTML Structure">
  ...
  <Step title="Choose CDN Import Method">
  ...
  <Step title="Connect Wallet for Uploads">
              ...
              if (!window.arweaveWallet) {
                statusDiv.innerHTML = `
                            <div class="error">
                                ...
                                <a href="https://wander.ar.io/" target="_blank">Install Wander Wallet</a>
                            </div>
                        `;
                return;
              }
            ...
            try {
              ...
              statusDiv.innerHTML = `
                        <div class="success">
                            ...
                            <strong>View File:</strong> <a href="https://turbo-gateway.com/${
                              result.id
                            }" target="_blank">turbo-gateway.com/${result.id}</a><br>
  ...
  <Step title="Enable HTTPS for Production">
  ...
  <Step title="Configure Content Security Policy">
    ...
    <meta
      ...
      content="
        ...
        connect-src 'self' https://upload.ardrive.io https://payment.ardrive.io https://turbo-gateway.com;
        img-src 'self' data:;
    "
    />
    ```
...
For more advanced implementations, see the [Next.js](./nextjs.mdx) and [Vite](./vite.mdx) framework guides, or explore the [Turbo SDK examples](https://github.com/ardriveapp/turbo-sdk) repository.
