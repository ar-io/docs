...
description: "Complete guide to managing Ar.io Name System (ArNS) names and records"
---
...
- **Transfer ownership** of names through the ANT (Arweave Name Token) system — ANTs are Metaplex Core NFTs tradeable on Solana marketplaces
...
<Cards>
  <Card
    ...
    description="Learn how to register and purchase ArNS names using the arns.ar.io interface"
