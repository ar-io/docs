...
- A Solana wallet with ARIO tokens and SOL for transaction fees

## Basic Setup

**Initialize the SDK with your Solana wallet:**

```javascript
const { ARIO } = require("@ar.io/sdk");

// Initialize ARIO with a Solana signer for transactions
// See the SDK Configuration page for how to create a signer from @solana/kit
