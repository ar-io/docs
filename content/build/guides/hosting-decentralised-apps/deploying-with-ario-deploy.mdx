...
<Callout type="warn" title="Two-Key Model">
  ...
  - **`DEPLOY_KEY`** — pays for the Arweave upload (Arweave, Ethereum, Polygon, or Solana wallet)
...
<Steps>
  <Step title="Fund your wallet with Turbo Credits">
    ...
    Visit the [Console app](https://console.ar.io/account) and connect your deployment wallet to view your current balance and top-up history.
  ...
  <Step title="Build and deploy to Arweave">
    ...
    <Tabs items={['Arweave Wallet', 'EVM Wallet']}>
      ...
      <Tab value="EVM Wallet">
        For EVM wallets (Ethereum, Polygon, Base), use your raw private key for the upload. The `ARNS_KEY` is always a base58 Solana secret key:
