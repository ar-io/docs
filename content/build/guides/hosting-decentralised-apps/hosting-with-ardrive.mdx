...
- Learn more about [preparing your dApp for deployment](/build/guides/hosting-decentralised-apps)
...
<Steps>
  ...
  <Step title="View and Share Your dApp">
    ...
    - Append the Data TX ID to a gateway URL: `https://turbo-gateway.com/YOUR-TX-ID`
  ...
  <Step title="Assign a Friendly Name (Optional)">
    ...
    - If not, purchase one from [arns.ar.io](https://arns.ar.io)
