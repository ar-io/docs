...
A tool for easily obtaining a normalized addresses from public keys can be found at [ar://normalize-my-key](https://normalize-my-key.ar.io/)
...
The [ar://normalize-my-key](https://normalize-my-key.ar.io/) tool implements this discovery process, allowing you to look up an address or transaction hash/signature to automatically recover the public key and derive the normalized address.
