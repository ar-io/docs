...
- Your Gateway should have been cloned using git. If you haven't, follow the installation instructions for [windows](TODO: find correct link) or [linux](TODO: find correct link).
...
If the release number displayed includes `-pre` it means that your gateway is using the `develop` branch of the github repo for the gateway code. Follow steps in our [troubleshooting guide](TODO: find correct link) to switch over to the more stable `main` branch.
