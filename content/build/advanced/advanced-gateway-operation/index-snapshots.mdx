...
You can also use the [Grafana Extension](/build/advanced/advanced-gateway-operation/monitoring-with-grafana) to view the last block imported in a more human readable format.
