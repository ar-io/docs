    ...
    description={
      <>
        ...
        <div className="space-y-1 text-sm">
          ...
          <div className="flex items-center gap-2"><Globe className="w-4 h-4" /> GET turbo-gateway.com/[txId]</div>
...
- Access data via REST API: `GET turbo-gateway.com/[txId]`
...
```bash
curl https://turbo-gateway.com/[transaction-id-from-above]
```
...
<Cards>
  ...
  <Card
    ...
    description="Serve and query data free on Solana devnet before mainnet"
