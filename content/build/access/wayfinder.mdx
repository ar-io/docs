...
<Callout type="info">
  **Learn More:** For detailed information about Wayfinder architecture and how it works, see our [Wayfinder Documentation](/learn/wayfinder).
</Callout>
...
<Callout type="info">
  **Full API Reference:** For complete documentation of all Wayfinder core APIs, see the [Wayfinder Core SDK Reference](/sdks/wayfinder/wayfinder-core).
</Callout>
...
<Callout type="info">
  **Full API Reference:** For complete documentation of all Wayfinder React APIs, see the [Wayfinder React SDK Reference](/sdks/wayfinder/wayfinder-react).
</Callout>
...
- **PreferredWithFallbackRoutingStrategy** - Tries preferred gateway first, then falls back to a given fallback strategy
