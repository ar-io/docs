---
title: "ar.io SDK"
description: "JavaScript/TypeScript SDK for interacting with ar.io, including ArNS name management, gateway interactions, and Solana program operations"
---
...
<Callout type="info">
**Requires `@ar.io/sdk` version 3.23+** for Solana support. Write operations also need `@solana/kit` for signing — see the [Configuration](/sdks/ar-io-sdk/configuration) page for setup details.
</Callout>
...
<Cards>
  <Card
    icon={<Network />}
    title="ARIO Protocol Operations"
