...
Retrieves information for the ANT.
...
Retrieves the state of the ANT.
...
Returns all records on the configured ANT, including the required `@` record that resolve connected ArNS names.
