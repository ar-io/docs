...
<Callout type="info">
**Field naming note:** API responses use `processId` to refer to the ANT identifier. On Solana, this is the ANT's Metaplex Core NFT **mint address**. The field name is retained for SDK backwards compatibility.
</Callout>
