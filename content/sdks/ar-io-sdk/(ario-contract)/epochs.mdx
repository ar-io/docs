...
Retrieves the prescribed observers of the ARIO protocol. To fetch prescribed observers for a previous epoch set the `epochIndex` to the desired epoch index.
