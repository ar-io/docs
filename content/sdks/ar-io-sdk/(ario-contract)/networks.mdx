...
The SDK provides APIs for claiming tokens via a faucet on the ar.io Testnet (Solana devnet). All token requests require a captcha to be solved, and the faucet is rate limited to prevent abuse.
