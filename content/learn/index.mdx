...
import { BookOpen, Wrench, Package, Code, Server, Globe, ArrowRight, Zap, Shield, Infinity } from 'lucide-react';

# Build on the Permanent Web
...
<Cards>
  <Card
    icon={<BookOpen />}
    title="Learn"
    description="Understand AR.IO concepts, ArNS, gateways, and the permanent web ecosystem"
