...
Users can register a name, like `ardrive`, within the ArNS Registry. Before owning a name, they must create an Ar.io Name Token (ANT), a Metaplex Core NFT on Solana used by ArNS to track the ownership and control over the name.
