...
You can view current live pricing at [arns.ar.io](https://arns.ar.io/#/prices) to see these formulas in action, or compare name prices alongside storage costs in the [ar.io Console name price table](https://console.ar.io/pricing?type=domains).
