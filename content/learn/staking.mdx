...
You'll need ARIO tokens to delegate. These can be obtained through several methods:

**Centralized Exchanges:**

- [Gate.io](https://www.gate.com/trade/ARIO_USDT) - Trade ARIO/USDT (Note: US not supported)

**Decentralized Exchanges:**

- [PermaSwap](https://www.permaswap.network/#/ao/xU9zFkq3X2ZQ6olwNVvr1vUWIjc3kXTWr7xKQD6dh10%26qNvAoz0TgcH7DMg8BCVn8jF32QH5L6T29VjHxhHqqGE?tab=swap) - Swap directly on AO
- [Dexi](https://dexi.arweave.net/#/pool/aDeXXVoY5bYWk2k5SFK9bSIxDFw1M9d2ac2vRZEnW7s) - Decentralized exchange for AO tokens

**Mobile & Browser Apps:**

- [Wander App](https://www.wander.app/download?tab=download-browser) - Swap directly in the Wander mobile app or browser extension

<Callout type="info">
  **Note:** This list is non-exhaustive. ARIO tokens may be available on other
  exchanges and platforms not listed here.
</Callout>
