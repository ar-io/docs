...
<div style={{textAlign: "center", fontStyle: "italic", width: "80%", margin: "0.5rem auto"}}>
...
On Solana, reward distribution is driven by a permissionless 6-step [epoch pipeline](/learn/oip/epoch-pipeline) rather than a single atomic operation:
