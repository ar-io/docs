...
![Epoch reward distributions showing eligible vs distributed ARIO tokens](/content/epoch-distributions.png)
...
On Solana, reward distribution is driven by a permissionless 6-step [cranker pipeline](/learn/oip/cranker) rather than a single atomic operation:
