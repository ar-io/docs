...
```mermaid
sequenceDiagram
    participant SC as ar.io Solana Programs
...
- **Solana Programs**: Selects up to 50 observers using weighted random selection
- **Solana Programs**: Generates 2 prescribed ArNS names for all observers to test
...
- **Observers**: Submit failed gateway lists to the ar.io Solana Programs for consensus voting

### Evaluation and Distribution

- **Solana Programs**: Tallies all observer votes (≥50% pass = functional gateway)
- **Solana Programs**: Distributes rewards at epoch end based on performance
