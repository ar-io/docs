...
Explore the detailed mechanics of each OIP component:

- **[Observer Selection](/learn/oip/observer-selection)** - How gateways are chosen as observers using weighted criteria and entropy
- **[Reporting](/learn/oip/reporting)** - Observer responsibilities for dual-channel submission to Arweave and smart contract  
- **[Performance and Weights](/learn/oip/performance-evaluation)** - Vote tallying, consensus mechanisms, and weight calculations
- **[Distributions](/learn/oip/reward-distribution)** - Reward formulas, funding mechanisms, and penalty structures
