...
- **Don't depend on Solana for data serving**: Gateways operate independently — Solana is only used for protocol state (registry, staking, ArNS)
- **Don't execute smart contracts**: Protocol logic runs on Solana programs, not gateways
