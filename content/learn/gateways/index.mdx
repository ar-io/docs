...
import { Building, Download, Shield, Server, CreditCard, Share2 } from "lucide-react";
...
<Cards>
  ...
  <Card
    title="Index Sharing"
    description="How gateways share signed indexes that locate data items, and why they can be trusted"
