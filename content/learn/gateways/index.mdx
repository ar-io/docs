...
<Cards>
  ...
  <Card
    ...
    description="Understand how gateways fetch from multiple sources with resilient fallback"
    href="/learn/gateways/data-retrieval"
    icon={<Download className="w-8 h-8" />}
  />
  <Card
    title="Data Availability"
    description="Choose an access strategy and understand guarantee levels for production"
