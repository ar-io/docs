...
```mermaid
graph TB
    subgraph "Centralized Access (Problem)<br/>"
        U1[Users] --> AW[arweave.net]
        AW --> AR1[Arweave]
        style AW fill:#ffcccc,stroke:#ff0000,stroke-width:3px
    end
```
...
```mermaid
graph TB
    subgraph "Decentralized Access (Wayfinder Solution)"
        ...
        WF -.-> V[Content Verification]
        V -.-> U2
    end
    
    style WF fill:#e6f2ff,stroke:#333,stroke-width:3px
    style V fill:#bfb,stroke:#333,stroke-width:2px,color:#333
    style G1 fill:#e6f2ff,stroke:#333,stroke-width:2px,color:#333
    style G2 fill:#e6f2ff,stroke:#333,stroke-width:2px,color:#333
    style G3 fill:#e6f2ff,stroke:#333,stroke-width:2px,color:#333
    style GN fill:#e6f2ff,stroke:#333,stroke-width:2px,color:#333
```
