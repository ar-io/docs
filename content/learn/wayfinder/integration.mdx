...
- **Telemetry collection** - Understand gateway performance across routing strategies
...
const wayfinder = new createWayfinderClient({
  ...
  verification: 'hash',
  routing: 'preferred',
  preferredGateway: 'ar-io.net',
});
```

This pattern ensures:
1. **Primary traffic** goes to your preferred gateway (for example, one you run or trust)
...
For detailed routing strategy options, see the [routing strategies documentation](/sdks/wayfinder/wayfinder-core/routing-strategies).
...
Enable telemetry to understand how Wayfinder performs across gateways:
