...
- **Bundling with [ar.io](https://ar.io) and Turbo**: Bundling packs multiple files into one transaction, reducing costs and congestion. Ar.io and Turbo optimize this, enabling fast, cheap uploads of large datasets like websites. Turbo is an ar.io gateway run by the ArDrive team, and it bundles your files before posting them to Arweave.
