...
**Computation**: AO, Solana, and other platforms enable smart contracts and processing  
...
<div style={{display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.75rem', maxWidth: '500px', margin: '2rem auto'}}>
  ...
  <div style={{display: 'flex', gap: '0.75rem', width: '100%'}}>
    <div style={{
      ...
      <img src="/ecosystem-logos/logo-ao.png" alt="AO" style={{width: '28px', height: '28px', marginBottom: '0.25rem'}} />
      AO
      <div style={{fontSize: '0.85rem', fontWeight: 'normal', marginTop: '0.25rem'}}>
        Parallel Compute
      </div>
    ...
    <div style={{
      ...
      <img src="/brand/ario-white.svg" alt="ar.io" style={{width: '28px', height: '28px', marginBottom: '0.25rem'}} />
      ar.io
      <div style={{fontSize: '0.85rem', fontWeight: 'normal', marginTop: '0.25rem'}}>
  ...
  <div style={{
    ...
    <img src="/ecosystem-logos/logo-arweave.png" alt="Arweave" style={{width: '28px', height: '28px', marginBottom: '0.25rem'}} />
    Arweave
    <div style={{fontSize: '0.85rem', fontWeight: 'normal', marginTop: '0.25rem'}}>
...
### Layer 2: Decentralized Compute
**Core Responsibility: Smart Contract Execution**

Multiple platforms provide computation for the permaweb ecosystem:

**AO** runs hyper-parallel compute directly on Arweave data:
...
**Solana** provides high-throughput program execution:
- **SPL Token operations** — Token transfers, staking, and DeFi
- **Program state** — On-chain registries and protocol logic (used by ar.io)
