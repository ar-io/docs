...
| **Metaplex Core NFT** | ANT (Arweave Name Token) | Each ArNS name is backed by an NFT. Trade on Tensor/Magic Eden. Holds DNS-like records. |
...
| **ARIO tokens** | Pay for ArNS names, staking. Get from [Jupiter](https://jup.ag) or [Raydium](https://raydium.io). |
...
| Upload (larger files) | Pay with SOL, ARIO, or fiat. [See pricing](https://turbo.ar.io) |
