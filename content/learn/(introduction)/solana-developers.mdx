...
- **Human-readable URLs** — `yourapp.permagate.io` instead of a 43-character transaction ID
...
// https://my-cool-app.permagate.io
...
https://my-cool-app.permagate.io      → served by permagate.io gateway  
...
```
https://docs_my-cool-app.permagate.io  → the "docs" undername
https://api_my-cool-app.permagate.io   → the "api" undername
```
