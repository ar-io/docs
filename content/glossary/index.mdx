...
An ar.io node that serves Arweave data over HTTP: it retrieves, caches and indexes data, resolves ArNS names, and exposes standard interfaces for the permaweb. Anyone can run one. Turbo is a managed gateway that also accepts paid uploads. See [Gateways](/learn/gateways).
