...
**Primary Names** - [Decentralized domain names](https://docs.ar.io/arns#primary-names) that:
...
**Want to learn more?** Explore [ArNS Primary Names](/use-cases/arns-primary-names) for domain management.
