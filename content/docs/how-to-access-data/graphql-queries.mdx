...
<Callout type="info">
  **For Simple Access:** If you already know the transaction ID and just need to
  access the data, use [HTTP Requests](/how-to-access-data/http-requests)
  instead. GraphQL is perfect for discovering data when you don't know the
  transaction ID.
</Callout>
