...
Turbo is ar.io's managed gateway stack: it serves permanent data like any ar.io gateway, and adds paid uploads. These APIs are the HTTP interface to the upload and payment half.
