---
title: "Turbo APIs"
description: "The upload and payment service behind ar.io and ArDrive"
---
...
Turbo is the upload and payment service behind ar.io and ArDrive: it bundles your files into ANS-104 data items, issues the credits you pay with, and posts the data permanently to Arweave. These APIs are the HTTP interface to it.
...
| --- | --- | --- |
| Upload | `https://turbo.ardrive.io` | `GET /price/:token/:byteCount` |
| Payment | `https://turbo.ardrive.io/v1` | `GET /v1/price/bytes/:byteCount` |

<Callout type="info">
  Upload endpoints are served at the root, **not** under `/v1` — prefixing them
  returns a 404. Payment endpoints require the `/v1` prefix.
</Callout>
